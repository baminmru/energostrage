...
Module Module1
        ...
        For Each node In nodes
            Try
                ...
                If drv.Connect(node.Attributes("ip").Value, node.Attributes("addr").Value) Then
                    ...
                    Try
                        a = drv.GetTotal()
                        ProcessData(node.Attributes("ip").Value, node.Attributes("addr").Value, node.Attributes("name").Value, a)
                    Catch ex As Exception
    ...
    Private Sub ProcessData(ip As String, naddr As String, name As String, a As M206.Archive)
