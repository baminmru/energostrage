...
Public Class maker
    ...
    Private Function GetData(ByVal deviceID As Integer, ByVal ID As Integer) As DataTable
        ...
        If ID = 1 Then
            ...
            q = q + " from edata_hour join echanel on edata_hour.chanel_id=echanel.chanel_id "
            q = q + " where echanel.node_id=" & deviceID.ToString & " and edata_hour.p_date>=" + OracleDate(dfrom) + "  and edata_hour.p_date<= " + OracleDate(dto) + "   group by edata_hour.p_date order by edata_hour.p_date "
        ...
        If ID = 2 Then
            ...
            q = q + " from edata_hour join echanel on edata_hour.chanel_id=echanel.chanel_id join enodes on enodes.node_id=echanel.node_id "
