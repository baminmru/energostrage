    ...
    Private Sub cmdSave_Click(sender As System.Object, e As System.EventArgs) Handles cmdSave.Click
        If id = 0 Then
            ...
            Try
                If chkLocked.Checked Then
                    s = "insert into users(usersid,login,password,locked,email) values(users_seq.nextval,'" + txtLogin.Text + "','" + txtPassword.Text + "',1,'" + txtEmail.Text + "')"
                Else
                    s = "insert into users(usersid,login,password,locked,email) values(users_seq.nextval,'" + txtLogin.Text + "','" + txtPassword.Text + "',0,'" + txtEmail.Text + "')"
                End If
        ...
        Else
            Try
                Dim s As String
                If chkLocked.Checked Then
                    s = "update users set  login='" + txtLogin.Text + "',password='" + txtPassword.Text + "',email='" + txtEmail.Text + "' ,locked=1  where usersid=" + id.ToString
                Else
                    s = "update users set  login='" + txtLogin.Text + "',password='" + txtPassword.Text + "' ,email='" + txtEmail.Text + "', locked=0   where usersid=" + id.ToString
                End If
