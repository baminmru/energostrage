Public Class frmCheckLoad
    ...
    POWERCOST AS ""Цена"",
      ...
      JOIN TARIF ON pr_info.TARIFID = tarif.TARIFID "
        Dim dt As DataTable
        dt = tvmain.QuerySelect(qry + " where theyear=" + numY.Value.ToString() + " and themonth=" + numM.Value.ToString())
        dgv.DataSource = dt
        ...
        dt2 = tvmain.QuerySelect(qry + " where theyear=" + numY.Value.ToString() + " and themonth=" + numM.Value.ToString())
