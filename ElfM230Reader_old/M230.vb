...
Public Class M230
    ...
    Public Sub GetCur()
        ...
        ' Cos phi по фазам
        ' =====================================================
        merc_gd(na, Cos, "x08x16x30x00x00", 0.001)
        Arch.C1 = Cos(1)
        Arch.C2 = Cos(2)
        Arch.C3 = Cos(3)
        ...
        ' Напряжение по фазам
        ' =====================================================
        merc_gd(na, Uv, "x08x16x11x00x00", 0.01)
    ...
    Public Sub GetTotal()
        ...
        merc_gd2(na, Tot, "x05x60x00x00x00", 0.001)
        If lastSz = 15 Then
            Arch.AP1 = Tot(0)
            Arch.AP2 = Tot(1)
            Arch.AP3 = Tot(2)
            ...
            If ok Then
                If tot = 0 Then
                    ...
                    ElseIf rcnt = 19 Then
                        ...
                        ret(1) = MakeLong(result, 1 + 3, 4) * factor
                        ret(2) = MakeLong(result, 1 + 6, 4) * factor
                        ret(3) = MakeLong(result, 1 + 9, 4) * factor
                    End If
                Else
                    ret(0) = MakeLong(result, 1, 4) * factor
                End If
