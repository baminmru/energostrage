...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.lblCPHONE.Location = New System.Drawing.Point(14, 205)
        ...
        'txtCPHONE
        '
        Me.txtCPHONE.Location = New System.Drawing.Point(14, 227)
        ...
        Me.cmbTransport.Items.AddRange(New Object() {"MODEM", "COM", "NPORT", "VSX", "GSM Modem", "АССВ"})
        ...
        Me.Label4.Text = "Сетевой адрес прибора"
        '
        'txtNetAddr
        '
        Me.txtNetAddr.Location = New System.Drawing.Point(231, 288)
        Me.txtNetAddr.Name = "txtNetAddr"
        Me.txtNetAddr.Size = New System.Drawing.Size(165, 20)
        Me.txtNetAddr.TabIndex = 54
        '
        'editTPLT_CONNECT
        '
        Me.AutoScroll = True
...
#End Region
    ...
    End Sub
    Private Sub txtCPREFPHONE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Changing()
    ...
    Public Sub Save()
        If mRowReadOnly = False Then
            ...
            Try
                Item("NETADDR") = Val("0" + txtNetAddr.Text)
    ...
    Private Sub editTPLT_CONNECT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
