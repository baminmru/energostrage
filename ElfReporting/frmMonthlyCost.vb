...
Public Class frmMonthlyCost
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Chart1.Titles.Clear()
        Chart1.Titles.Add("Динамика общих затрат на электроснабжение " & vbCrLf & "по МР СЗ за " & v2016 & " год, тыс.руб.")
        ...
        For Each row In dts.Rows
            ...
            dt = TvMain.QuerySelect("select  sum(power*cost) POWER , theMonth from estat where  estat.senderid=" & row("SENDER_ID").ToString & " and theyear= " & v2016 & " group by THEMONTH order by theMONTH")
        ...
        dt = TvMain.QuerySelect("select  sum(power*cost) POWER , theMONTH from estat where theyear= " & v2016 & " group by THEMONTH order by themonth")
        ...
        dt = TvMain.QuerySelect("select  sum(power * cost) POWER  from estat where theyear= " & v2015 & " ")
