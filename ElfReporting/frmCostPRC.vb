Public Class frmCostPRC
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Chart1.Titles.Clear()
        Chart1.Titles.Add("Затраты филиалов МР СЗ в долях от общих в " & v2016 & " году")
        ...
        dt = TvMain.QuerySelect("select  sum(power*COST) POWER ,SENDER_NAME from estat join esender on estat.senderid=esender.sender_ID where theyear=" & v2016 & " group by sender_name")
