...
Public Class frmDynamicPower
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ' Set chart title
        Chart1.Titles.Clear()
        Chart1.Titles.Add("Динамика общего потребления электроэнергии " & vbCrLf & "по МР СЗ  с " & v2010 & " по " & v2016 & " годы, тыс.кВт * ч")
        ...
        For Each row In dts.Rows
            ...
            dt = TvMain.QuerySelect("select  sum(power) POWER , theYEAR from estat where  estat.senderid=" & row("SENDER_ID").ToString & " and theyear>= " & v2010 & " and theyear <=" & v2016 & " group by THEYEAR order by theyear")
        ...
        dt = TvMain.QuerySelect("select  sum(power) POWER , theYEAR from estat where theyear>= " & v2010 & " and theyear <=" & v2016 & " group by THEYEAR order by theyear")
