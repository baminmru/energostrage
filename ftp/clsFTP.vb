...
#Region "Public Subs and Functions"
    ...
    Public Function GetFileList(ByVal sMask As String) As String()
        ...
        If (Not (m_iRetValue = 150 Or m_iRetValue = 125 Or m_iRetValue = 450)) Then
        ...
        If m_iRetValue <> 450 Then
            Do While (True)
                ...
                ''If (bytes = 0 < m_aBuffer.Length) Then
                If (bytes = 0) Then
                    Exit Do
                End If
            Loop
    ...
    Public Function Login() As Boolean
        ...
        Dim iP As IPAddress = IPAddress.Parse(m_sRemoteHost)
    ...
    Public Sub UploadFile(ByVal sFileName As String,
        ...
        If (File.Exists(sFileName)) Then
            ...
            input = New FileStream(sFileName, FileMode.Open, FileAccess.Read, FileShare.None)
            If (offset <> 0) Then
